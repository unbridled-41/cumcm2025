...
达标_df["BMI组"] = pd.cut(达标_df["BMI"], bins=bins, labels=labels, right=False)
...
print("=== 各BMI组的最佳检测时点（基于风险函数）===")
print(result_df.to_string(index=False))

# 保存结果
result_df.to_excel("Q2_result_risk.xlsx", index=False)
print("\n结果已保存到 Q2_result_risk.xlsx 和 Q2_risk_curve.png")
